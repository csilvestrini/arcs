...
import arcs.core.data.proto.decodeParticleSpecs
...
class PolicyTranslationTest {
    ...
    lateinit var recipes: Map<String, Recipe>
//    lateinit var particleSpecs: Map<String, ParticleSpec>
    lateinit var policies: Map<String, Policy>
...
//        particleSpecs = proto.decodeParticleSpecs().associateBy { it.name }
    ...
    companion object {
        ...
        private val EMPTY_SINGLETON_TYPE = SingletonType(EntityType(Schema.EMPTY))
